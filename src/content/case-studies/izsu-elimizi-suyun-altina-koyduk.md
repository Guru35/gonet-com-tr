...
services:
  ...
  - "Kreatif kampanya tasarımı"
  - "Kamu kurumu iletişim danışmanlığı"
year: 2018
results:
  - metric: "Hedef"
    value: "Kentlilerin su kullanım farkındalığı"
  - metric: "Slogan"
    value: "'Elimizi Suyun Altına Koyduk'"
  - metric: "Sektör kategorisi"
    value: "Kamu sosyal sorumluluk + sürdürülebilirlik iletişimi"
lang: tr
draft: false
---
...
- **Hikaye anlatımı** — kurumun ne yaptığını sayısal raporla değil, somut hikayelerle aktarma
- **Kentli katılımı** — kullanıcı içeriği teşvik eden mekanizmalar
...
- **DEPARK (Dokuz Eylül Teknopark)** — danışmanlık + web sitesi
- **Prof. Nükhet Hotar** — kişisel dijital varlık yönetimi

## Neden Gonet?

Kamu kurumu iletişimi üç noktada özel hassasiyet gerektirir:

1. **Düzenleyici uyum** — kamu reklamcılığı + sosyal medya kullanımı için belirli sınırlar var
2. **Politik denge** — partizan algı yaratmadan iletişim
3. **Saygın dil + doğru mecra** — kamu kurumunun ciddiyetini korurken sosyal medyada erişim

Gonet'in **4 büyük partiyle de çalışmış olması** politik denge konusundaki tecrübesini, **DEPARK mukimi olması** akademik/kurumsal dil yatkınlığını gösterir.
